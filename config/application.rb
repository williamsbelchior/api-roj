...
Jets.application.configure do
  ...
  # }
  # The config.function settings to the CloudFormation Lambda Function
  # properties.
  # http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-
  # resource-lambda-function.html
  # Underscored format can be used for keys to make it look more ruby-ish.

  # Assets settings
  # The config.assets.folders are folders within the public folder that will be
  # set to public-read on s3 and served directly. IE: public/assets
  # public/images public/packs
  ...
  # defaults to the s3 bucket url
  # IE: https://s3-us-west-2.amazonaws.com/demo-dev-s3bucket-1inlzkvujq8zb

  # config.api.endpoint_type = 'PRIVATE' # Default is
  # 'EDGE' https://amzn.to/2r0Iu2L
  # config.api.authorization_type = 'AWS_IAM' # default is
  # 'NONE' https://amzn.to/2qZ7zLh
  ...
  # By default logger needs to log to $stderr for CloudWatch to
  # receive Lambda messages,
  # but for local testing environment you may want to log these messages
  # to 'test.log'
  # file to keep your
